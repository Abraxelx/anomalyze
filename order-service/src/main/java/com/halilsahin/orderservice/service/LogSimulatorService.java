package com.halilsahin.orderservice.service;

import com.halilsahin.orderservice.kafka.KafkaLogProducer;
import com.halilsahin.orderservice.model.LogEvent;
import com.halilsahin.orderservice.model.LogLevel;
...
public class LogSimulatorService {
    ...
    private void generateLogs() {
        LogEvent logEvent = LogEvent.builder()
                ...
                .message(String.format("Sipariş işlemi: ORD-%d", ++orderCounter))
                .relatedObjectId("ORD-" + orderCounter)
