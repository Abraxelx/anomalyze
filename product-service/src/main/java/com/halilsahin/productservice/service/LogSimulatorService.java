package com.halilsahin.productservice.service;

import com.halilsahin.productservice.kafka.KafkaLogProducer;
import com.halilsahin.productservice.model.LogEvent;
import com.halilsahin.productservice.model.LogLevel;
...
public class LogSimulatorService {
    ...
    private void generateLogs() {
        LogEvent logEvent = LogEvent.builder()
                ...
                .message(String.format("Ürün işlemi: PROD-%d", ++productCounter))
                .relatedObjectId("PROD-" + productCounter)
